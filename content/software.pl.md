...
Wolne oprogramowanie, które rozwijam.

## Timew-one-line-summary

{{< lang en >}}Timew-one-line-summary{{< /lang >}} to rozszerzenie dla [Timewarrior](https://timewarrior.net/ "|hreflang:en|lang:en"), które generuje jednolinikowy raport o czasie spędzonym nad zadaniami. Umożliwia to wyświetlanie tych informacji na pasku stanu.

* Repozytorium:
[codeberg.org/vilchy/timew-one-line-summary](https://codeberg.org/vilchy/timew-one-line-summary "|hreflang:en|lang:en"),

* Licencja:
[GNU General Public License v3.0](https://www.gnu.org/licenses/gpl-3.0-standalone.html "|hreflang:en|lang:en"),

* Język:
[Haskell](https://www.haskell.org/ "|hreflang:en|lang:en").

## Pyresynth

Prosty pakiet do analizy dźwięków. (Prace w toku…)

* Repozytorium:
[codeberg.org/vilchy/pyresynth](https://codeberg.org/vilchy/pyresynth "|hreflang:en|lang:en"),

* Licencja:
[MIT License](https://opensource.org/license/mit/ "|hreflang:en|lang:en"),
...
Kilka implementacji sumy kroczącej kwadratów.
